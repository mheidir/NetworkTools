...
public class SNTPClient {
    public static void main(String[] args) {
        ...
        if(args.length==1) {
            ...
            try {
                ...
                getNTPTime(serverName);
                //return;
            } catch (IOException ex) {
                Logger.getLogger(SNTPClient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private static void getNTPTime(String serverName) throws IOException  {
        // Send request
